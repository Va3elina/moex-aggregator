        ...
        <div className="rounded-2xl p-5 bg-theme-secondary border border-theme relative">
            ...
            <div>
                ...
                >
                    ...
                    <div className="absolute" style={{ top: 19, bottom: 50, left: 'var(--chart-pad-left, 100px)', right: 'var(--chart-pad-right-single, 95px)' }}>
                    <svg
                        ref={flowChartRef}
                        width="100%"
                        height="100%"
                    ...
                    {flowsData?.flows?.length && (() => {
                        ...
                        return (
                            <div className="absolute pointer-events-none" style={{ top: 19, bottom: 50, right: 0, width: 'var(--chart-pad-right-single, 95px)' }}>
                                {ticks.map((val, i) => {
                    ...
                    <div className="absolute flex justify-between font-semibold px-2" style={{ bottom: 14, left: 'var(--chart-pad-left, 100px)', right: 'var(--chart-pad-right-single, 95px)', fontSize: 'var(--chart-font-x, 14px)', color: 'var(--axis-color, #9CA3B8)' }}>
                ...
                {flowsData?.flows && flowsData.flows.length > 1 && (() => {
                    ...
                    return (
                        <div className="relative select-none" style={{ height: 52 }} data-flow-nav>
                            {/* Неактивный трек */}
            ...
            {hoveredFlowIndex !== null && flowsData?.flows && (() => {
                ...
                return (
                    <div className="absolute z-20 pointer-events-none" style={{ left: clampedX, top: 38, transform: 'translateX(-50%)' }}>
