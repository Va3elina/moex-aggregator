"""Second parallel SBER chain fetcher — covers 2024-01-01 → 2026-05-19 (newer half).

Runs alongside fetch_sber_chain_fast.py which covers 2020-01-01 forward.
...
OUT_OPT = ROOT / "sber_options_history_part2.csv"
OUT_FUT = ROOT / "sber_futures_history_part2.csv"
PROG = ROOT / ".sber_chain_progress2.json"
