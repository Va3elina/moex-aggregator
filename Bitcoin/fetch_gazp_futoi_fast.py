"""Fast GAZP futoi EOD fetcher - only last snapshot per day via latest=1. Ticker=GZ."""
import requests
import csv
import time
...
OUT = Path(__file__).parent / "gazp_futoi_history.csv"
URL = "https://iss.moex.com/iss/analyticalproducts/futoi/securities/GZ.json"
