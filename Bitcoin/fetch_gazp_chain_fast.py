...
Output: gazp_options_history.csv, gazp_futures_history.csv
"""
import requests
import csv
import time
...
OUT_OPT = ROOT / "gazp_options_history.csv"
OUT_FUT = ROOT / "gazp_futures_history.csv"
PROG = ROOT / ".gazp_chain_progress.json"
