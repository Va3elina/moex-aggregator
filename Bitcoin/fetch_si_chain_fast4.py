...
Output: si_options_history_part4.csv (settlement prices, OI, volume per option per day)
        si_futures_history_part4.csv (underlying Si futures settles per day)
"""
import requests
...
OUT_OPT = ROOT / "si_options_history_part4.csv"
OUT_FUT = ROOT / "si_futures_history_part4.csv"
PROG = ROOT / ".si_chain_progress4.json"
