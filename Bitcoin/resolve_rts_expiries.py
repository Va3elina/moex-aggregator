"""Resolve exact expiry (LSTDELDATE) for each unique RTS option expiry_code.

Output: rts_expiry_map.csv (expiry_code -> expiry_date)
"""
import pandas as pd
import requests
import time
...
OUT = ROOT / 'rts_expiry_map.csv'
INPUT_CSVS = ['rts_options_history.csv', 'rts_options_history_part2.csv',
