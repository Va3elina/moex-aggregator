"""Fast GAZP options chain history fetcher (part 1: 2020-01-01 -> 2026-05-19).

Mirror of fetch_sber_chain_fast.py but assetcode=GAZR, GZ-prefixed SECIDs,
SSL verify disabled with retries. Pagination limit 100.

Output: gazp_options_history_part2.csv, gazp_futures_history_part2.csv
"""
import requests
import csv
import time
...
OUT_OPT = ROOT / "gazp_options_history_part2.csv"
OUT_FUT = ROOT / "gazp_futures_history_part2.csv"
PROG = ROOT / ".gazp_chain_progress2.json"
