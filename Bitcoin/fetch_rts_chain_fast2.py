"""Fast RTS options chain history fetcher (part 2: 2024-01-01 -> 2026-05-30).
...
Output: rts_options_history_part2.csv, rts_futures_history_part2.csv
"""
import requests
import csv
import time
...
OUT_OPT = ROOT / "rts_options_history_part2.csv"
OUT_FUT = ROOT / "rts_futures_history_part2.csv"
PROG = ROOT / ".rts_chain_progress2.json"
