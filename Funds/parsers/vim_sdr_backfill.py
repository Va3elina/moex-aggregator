...
# Цель backfill — EQMX: индексный фонд с equity holdings.
# LQDT (cash/REPO) и GOLD (ОМС/REPO) пропускаются — у них нет классических
# equity holdings, и их monthly SCHA не несёт полезной информации для UI.
# Для них intraday-данные собираются через vim_intraday.py (wealthim /structure/).
BACKFILL_TICKERS = ["EQMX"]
