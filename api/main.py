...
# Сколько САМЫХ ВОСТРЕБОВАННЫХ активов держим тёплыми. Спрос за день (замер
# 2026-08-10): 19 активов из 91, и распределение резкое — SR 79 обращений,
# MX 31, дальше по 2-9. Двенадцати хватает с запасом на смену интереса, а
# кеш остаётся компактным: ~12 × 6 сочетаний × 2 тарифных варианта ≈ 145
# ключей вместо 1100, и cache_updater обходит их за секунды, а не за полминуты.
_WARM_CHART_TOP_N = 12
