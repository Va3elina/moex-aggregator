...
def get_cbr_flows(
    ...
    Tier-gating (2026-08):
      - Free: вся история и свежие данные, но виден только «розничный» срез
        участников (categories_whitelist) и категории нельзя скрывать вручную.
      - Basic/Pro: все категории + ручные фильтры.
    Задержки данных (data_delay_hours) больше нет ни на одном тарифе — код
    ниже её по-прежнему умеет применять, если лимит вернут в матрицу.
    """
