...
- **Начинка индикаторов** (графики/drawer/режимы/фиксы) живёт на сайте (`framedata.ru/embed/*`)
...
4. **Privacy practices**: вставить обоснования разрешений + раскрытие данных из `LISTING.md`.
   Privacy policy URL: `https://framedata.ru/privacy` (раздел про расширение уже добавлен).
