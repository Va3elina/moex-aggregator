...
const СВЯЗИ: Record<string, { имя: string; цвет: string; порядок: number }> = {
  ...
  раскрытие_о:   { имя: 'раскрытия',           цвет: '#5DA3E9', порядок: 8.6 },
  объявление_о:  { имя: 'объявления биржи',    цвет: '#5BD49C', порядок: 8.7 },
  отчёт_о:       { имя: 'отчёты с цифрами',    цвет: '#5DA3E9', порядок: 8.8 },
  событие_фонда: { имя: 'фонды меняли позицию', цвет: '#5BD49C', порядок: 2.5 },
  событие_индекса: { имя: 'входы и выходы из индексов', цвет: '#5BD49C', порядок: 3.5 },
...
const ВИД_ПОДПИСЬ: Record<string, string> = {
  ...
  disclosure: 'раскрытие', exchange: 'объявление биржи', report: 'отчёт',
  index_event: 'событие индекса', fund_event: 'событие фонда',
};
