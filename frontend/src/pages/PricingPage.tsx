...
function ComparisonMatrix() {
  ...
  const sections: Array<{
    ...
    },
    {
      title: 'Сделки фондов',
      icon: Wallet,
      // Раздел открыт всем (fund_trades_access=true), платными остаются свежий
      // срез и выбор своего пула фондов (fund_trades.fund_picker, 2026-08-09).
      rows: [
        ['Свежий срез «что купили»', '—', 'Да', 'Да'],
        ['Выбор конкретных фондов', '—', 'Да', 'Да'],
      ],
    },
    {
    ...
    },
    {
      title: 'Сезонность',
      icon: CalendarDays,
      // Индикатор полностью бесплатен с 2026-08 (features.py: seasonality) —
      // все активы, все режимы включая внутридневной, вся история на всех тирах.
      rows: [
        ['Активов', 'Все', 'Все', 'Все'],
