...
// Окна рекорда. 1 и 3 месяца намеренно убраны — слишком частый шум; охотимся за
// редкими рекордами (6 мес / год / всё время). Значение уходит в threshold как дни.
const EXTREME_PERIODS = [
  { value: '180', label: 'за 6 месяцев' },
...
const OI_ALERT_METRICS: AlertMetricOption[] = [
  ...
  },
  {
    ...
    // period = окно (уходит в threshold как дни: 180/365/0=всё время).
