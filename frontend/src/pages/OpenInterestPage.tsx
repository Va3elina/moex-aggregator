        ...
        <div className="flex flex-wrap items-center gap-2 md:gap-3">
          ...
          <AlertBellButton
            ...
            metrics={[
              ...
              {
                key: 'oi_z_fiz',
                label: 'OI: аномалия (физлица)',
                indicator: 'oi_zscore', metric: 'zscore', clgroup: 'FIZ', unit: 'σ', defaultThreshold: 2.5,
              ...
              {
                key: 'oi_z_yur',
                label: 'OI: аномалия (юрлица)',
                indicator: 'oi_zscore', metric: 'zscore', clgroup: 'YUR', unit: 'σ', defaultThreshold: 2.5,
                ops: [{ value: 'gt', label: 'превысит' }],
                hint: 'z = на сколько σ дневное изменение чистой позиции отклонилось от нормы. 2 — заметно, 3 — экстремально.',
              },
            ]}
