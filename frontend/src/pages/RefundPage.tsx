  ...
  return (
    <div className="max-w-3xl mx-auto px-4 md:px-6 py-8 md:py-12">
      ...
      <Section title="Что покупается">
        <p>
          На сервисе «Frame» (домен <strong>таймфрейм.рф</strong>) приобретается
      ...
      <Section title="Возврат денежных средств">
        ...
        <ul className="list-disc pl-6 space-y-2 mt-2">
          <li>
            По истечении 7 дней с момента оплаты — в этом случае возврат
            производится только при технических сбоях со стороны сервиса
            или ошибочном двойном списании.
          </li>
          <li>
