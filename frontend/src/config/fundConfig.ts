...
// которые есть в портфелях фондов и имеют логотип (Мечел/Whoosh/Сегежа/Софтлайн/
// СПБ Биржа/М.видео). Курируется ВРУЧНУЮ — не из БД. Стиль имени как в Сезонности.
