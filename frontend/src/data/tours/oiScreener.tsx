    ...
    body: (
      <>
        <p style={{ marginBottom: 4 }}>
          ...
          {' '}(полгода, 1–5 лет или всё время) — у сигнала загорается оранжевая
          метка периода: <strong>↑6мес</strong> = пробили максимум за полгода,
          ↓ = минимум. Чем длиннее период в метке, тем реже событие;
