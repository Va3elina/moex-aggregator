    ...
    body: (
      <>
        <p style={{ marginBottom: 4 }}>
          ...
          {' '}(полгода, 1–5 лет или всё время) — оранжевым пишем это вместо
          обычного сигнала: <strong>Максимум за полгода</strong>,
          {' '}<strong>Минимум за 5 лет</strong>, а самое сильное —
          {' '}<strong>Ист. максимум</strong> / <strong>Ист. минимум</strong>.
