    ...
    body: (
      <>
        <p style={{ marginBottom: 8 }}>
          ...
          уведомления в Telegram, только на экране. Показывает, по каким фьючерсам толпа
    ...
    body: (
      <>
        <p style={{ marginBottom: 4 }}>
          ...
          {' '}(квартал, полгода, 1–5 лет или всё время) — оранжевым пишем это
          вместо обычного сигнала: <strong>Макс за квартал</strong>,
          {' '}<strong>Мин за 5 лет</strong>, а самое сильное —
          {' '}<strong>Ист. макс</strong> / <strong>Ист. мин</strong>.
          Рекорд важнее дневной кратности, поэтому занимает её место.
        </p>
        <RecordLegend />
        <p>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p>
          При добавлении в избранное предложим <strong>настроить уведомление</strong>:
          тогда о резком движении сообщим сами, следить вручную не придётся.
        </p>
      </>
    ),
    position: 'bottom',
