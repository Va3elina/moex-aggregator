...
export const CBR_CATEGORY_COLORS: Record<string, CategoryColor> = {
  ...
  // === Потоки фондов («Деньги в фондах») ===
  // Фирменная пара сайта: зелёный приток / терракотовый отток. Держим здесь же,
  // чтобы движок гистограммы брал их тем же путём, что категории ЦБ.
  'Приток': { light: '#4CAF7D', dark: '#5BD49C' },
  'Отток':  { light: '#D4614A', dark: '#E07A5F' },
