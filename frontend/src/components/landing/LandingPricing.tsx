  ...
  return (
    <>
      ...
      >
        ...
        >
          {t('Бесплатный доступ к базовым индикаторам: без оплаты и без карты. Тарифы Basic и Pro пригодятся, когда понадобятся открытые позиции без задержки, расширенная история и продвинутые режимы.')}
        </p>
      </section>
