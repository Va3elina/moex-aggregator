          ...
          return (
            <div
              ...
              style={{
                ...
                // прижимаются к нижней границе data-area (≈ низ content-box
                // карточки), сохраняя ~3px зазор до нижней грид-линии. Вместе с
                // ужатым нижним паддингом карточки (md:pb-3) это даёт зазор
                // подписи→нижняя граница блока ~12-14px, как у графиков с
                // навигатором. На мобиле остаётся штатные 22px.
