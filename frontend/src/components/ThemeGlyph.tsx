 ...
 *
 * Раньше эта пара жила инлайном внутри ThemeToggle (шапка сайта). Теперь она
 * нужна ещё в двух местах песочницы (шапка оболочки + кнопка «Тема панели» в
 * тулбаре окна), поэтому вынесена сюда — чтобы не плодить копии одного SVG.
 *
