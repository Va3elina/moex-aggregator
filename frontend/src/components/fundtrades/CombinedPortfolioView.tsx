    ...
    const deskRow = (h: FundPortfolioHolding, idx: number, last: boolean, interactive: boolean) => {
        ...
        return (
            ...
            >
                ...
                <span style={{ textAlign: 'right', fontVariantNumeric: 'tabular-nums', fontSize: 'var(--fs-sm)', fontWeight: 800, color: 'color-mix(in srgb, var(--text-primary) 32%, transparent)' }}>{w.toFixed(2)}%</span>
        ...
        return (
            ...
            >
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    ...
                    <span style={{ fontVariantNumeric: 'tabular-nums', fontSize: 'var(--fs-sm)', fontWeight: 800, color: 'color-mix(in srgb, var(--text-primary) 32%, transparent)', flexShrink: 0 }}>{w.toFixed(2)}%</span>
                </div>
