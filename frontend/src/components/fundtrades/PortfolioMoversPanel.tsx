    ...
    const row = (m: FundTradesMover, last: boolean) => {
        ...
        return (
            ...
            >
                ...
                <span style={{ textAlign: 'right', whiteSpace: 'nowrap', fontVariantNumeric: 'tabular-nums', fontSize: 'var(--fs-sm)', color: 'color-mix(in srgb, var(--text-secondary) 70%, var(--text-primary))' }}>{num}</span>
            </div>
        );
    };
