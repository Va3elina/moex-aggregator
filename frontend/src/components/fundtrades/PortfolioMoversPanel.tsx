    ...
    const row = (m: FundTradesMover, last: boolean) => {
        ...
        return (
            ...
            >
                ...
                <span style={{ textAlign: 'right', whiteSpace: 'nowrap', fontVariantNumeric: 'tabular-nums', fontSize: 'var(--fs-sm)', fontWeight: 800, color: 'color-mix(in srgb, var(--text-primary) 32%, transparent)' }}>{num}</span>
            </div>
        );
    };
