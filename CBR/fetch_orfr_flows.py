...
⚠️ ЦБ дрейфует и РЕГИСТРОМ имён категорий (ORFR_2026-7: «Прочие банки» вместо
«Прочие Банки»). Имя категории — это ключ: и в PK таблицы, и в палитре/описаниях
фронта. Поэтому все имена проходят через canon_category() — см. CATEGORY_CANON.
